										...
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
											  ...
											  <div class="input-group date" id="e_start_date">
								                <input class="form-control ignore" name="start_date" required="true" id="e_start_date" value="<?= date('m/d/Y', strtotime($event->start_date))?>"/><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-calendar my-1"></i></span></span>
								              </div>
										...
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
											  ...
											  <div class="input-group date" id="e_end_date">
								                <input class="form-control ignore" name="end_date" value="<?= (!empty($event->end_date) ? date('m/d/Y', strtotime($event->end_date)) : '') ?>"/><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-calendar my-1"></i></span></span>
								              </div>
										...
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
											  ...
											  <?= $this->Form->control('event_photo', ['label' => false, 'class'=> 'form-control','type'=>'file', 'required' => false]) ?>
												...
												<?= $this->Html->image('default-user.png', [ 'height'=>'50px']); ?>
												<?php else: ?>   
