			...
			<div class="row">           
				<div class="col-md-4 col-lg-4 col-xl-4">
				  <div class="mb-3">
					...
					<?= $this->Form->control('location_name', ['label' => false, 'class'=> 'form-control', 'placeholder' => 'Location Name','readonly'=>'true']) ?>
				  </div>
				</div>			
				<div class="col-md-4 col-lg-4 col-xl-4">
				  <div class="mb-3">
				...
				<div class="col-md-4 col-lg-4 col-xl-4">
				  <div class="mb-3">
					...
					<?= $this->Form->control('zip', ['label' => false, 'class'=> 'form-control', 'type' => 'text','placeholder' => 'Zip Code' ]) ?>
				  </div>
				</div>
				<div class="col-md-4 col-lg-4 col-xl-4">
				  <div class="mb-3">
					<label class="form-label">Phone</label>
					<?= $this->Form->control('phone', ['label' => false, 'class'=> 'form-control', 'type' => 'text','placeholder' => 'Contact no.']) ?>
				  </div>
				</div>			
				<div class="col-md-4 col-lg-4 col-xl-4">
				  <div class="mb-3">
					<label class="form-label">Fax</label>
					<?= $this->Form->control('fax', ['label' => false, 'class'=> 'form-control', 'type' => 'text','placeholder' => 'Fax']) ?>
				  </div>
				</div>	
				<div class="col-md-4 col-lg-4 col-xl-4">
				  <div class="mb-3">
