            ...
            <tbody>
               ...
               <tr data-id="<?= $lead->id; ?>">
                  ...
                  <td class="text-muted">
                     ...
                     <span class="badge bg-green-lt"><?= $this->Html->link('Active', ['action' => 'change-status', $lead->id, 0]) ?></span>
                     <?php
                        }else{
                        ?>
                     <span class="badge bg-red-lt"><?= $this->Html->link('Inactive', ['action' => 'change-status', $lead->id, 1]) ?></span>
                     <?php } ?>
                  </td>
                  <td class="text-muted">
                     <?= $lead->modified ?>
