...
<div class="page-header">
	<div class="row align-items-center">
		...
		<div class="col-auto ml-auto d-print-none">       
			...
			<a class="btn btn-primary ml-3 d-sm-none btn-icon" href="<?= $this->Url->build(['controller'=>'events', 'action'=> 'add'])?>">
...
<div class="" id="" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="" role="document">
      <div class="card">
			...
			<?= $this->Form->Create(null, [ 'id'=>'addevent','class'=>'card-body','type'=>'file', 'url' => [
				'controller' => 'Events',
				'action' => 'add'
			]]) ?>		 
									...
									<div class="row mt-4">
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
												...
												<div class="btn-group">
													...
													<div id="select" style="width:55px;height:30px;margin: 2px;margin-left:30px;"></div>
										...
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
											  ...
											  <div class="input-group date" id="e_start_date">
								                <input class="form-control ignore" name="start_date" required="true" id="e_start_date"/><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-calendar my-1"></i></span></span>
								              </div>
										...
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
											  ...
											  <div class="input-group date" id="e_end_date">
								                <input class="form-control ignore" name="end_date"/><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-calendar my-1"></i></span></span>
								              </div>
										...
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
											  ...
											  <div class="input-group date" id="cancel_date">
								                <input class="form-control ignore" name="cancellation_date"/><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-calendar my-1"></i></span></span>
								              </div>
											</div>
										</div>
										<!--<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
											  ...
											  <?// $this->Form->control('  ', ['label' => false, 'class'=> 'form-control', 'placeholder' => 'Event Leader(s)']) ?>
											</div>
										</div>-->
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
										...
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
											  ...
											  <?= $this->Form->control('venue_address', ['label' => false, 'class'=> 'form-control', 'placeholder' => 'Venue Address', 'required' => false]) ?>
											</div>
										</div>
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
											  <label class="form-label">Venue Address2</label>
											  <?= $this->Form->control('venue_address2', ['label' => false, 'class'=> 'form-control', 'placeholder' => 'Venue Address', 'required' => false]) ?>
											</div>
										</div>									
										<div class="col-md-4 col-lg-4 col-xl-4">
											<div class="mb-3">
							...
							<div class="tab-pane" id="tab-description">
								<div class="row mt-4">
									<div class="col-md-12 col-lg-12 col-xl-12">
										<div class="mb-3">
										  <?= $this->Form->control('event_description', ['label' => false, 'class'=> 'form-control ignore', 'type'=> 'textarea', 'required' => false]) ?>
										</div>
									</div>
								</div>
								<div class="row d-flex">
								...
								<div class="row mt-4">
									...
									<div class="col-md-4 col-lg-4 col-xl-4">
									   <div class="mb-3">
										  ...
										  <?= $this->Form->control('event_fee_description', ['label' => false, 'class'=> 'form-control ignore', 'placeholder' => 'e.g. includes soda', 'required' => false]) ?>
									   </div>
									</div>
									<div class="col-md-4 col-lg-4 col-xl-4">
									   <div class="mb-3">
									...
									<div id="showlimit" style="display: none">
										<div class="col-md-4 col-lg-4 col-xl-4">
										   <div class="mb-3">
								...
								<div class="row mt-4">
									<div class="col-md-4 col-lg-4 col-xl-4">
										<div class="mb-3">
											  ...
											  <div class="input-group date" id="r_close_date">
								                <input class="form-control ignore" name="registration_close_date"/><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-calendar my-1"></i></span></span>
								              </div>
									...
									<div class="col-md-4 col-lg-4 col-xl-4">
										<div class="mb-3">
										  ...
										  <?= $this->Form->control('vendor_id', ['label' => false, 'class'=> 'form-control ignore', 'type' => 'select', 'options' => $vendors, 'required' => false]) ?>
										</div>
									</div>
									<!-- <div class="col-md-4 col-lg-4 col-xl-4">
										<div class="mb-3">
