...
class LeadsController extends AppController {
	...
	public function index() {
		...
		$paginateArray['conditions'][] = ['Leads.lead_status_id' => 1, 'Leads.location_id' => 2];
	...
	public function allLead() {
		...
		$paginateArray['conditions'][] = $conditions;
		$paginateArray['conditions'][] = ['Leads.location_id' => 2];
		$this->paginate = $paginateArray;
		$leads = $this->paginate($this->Leads);
		$this->set(compact('pageTitle', 'leads'));
	...
	public function add() {
		...
		$leadsource = $this->Leads->LeadSources->find('list', ['keyField' => 'id', 'valueField' => 'source_name'])->where(['location_id' => 2]);
