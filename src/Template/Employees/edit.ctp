...
<div class="row">
  <div class="col-12">
    <?= $this->Form->Create($employee, ['id'=> 'editEmployeeForm', 'class'=>'card']) ?>
                ...
                <div class="card">
                  <div class="table-responsive">
                    <table class="table table-vcenter card-table table-striped" id='clients-data'>
                      ...
                      <tbody> 
                       <?php
                            foreach ($employee->clients as $key => $value) {
                            ?>
                                <tr data-id="<?php echo $value['id'];?>"><td><?php echo $value['name'];?></td>
                                    <td data-id="<?php echo $value['id'];?>" class="delete" style="text-align: right;">X</td><td style="display:none;"><input type="hidden" name="clients[_ids][]" value="<?php echo $value['id'];?>"></td>
                                </tr>
                ...
                <div class="card">
                  <div class="table-responsive">
                    <table class="table table-vcenter card-table table-striped" id='locations-data'>
                      ...
                      <tbody> 
                      <?php
                            foreach ($employee->locations as $key => $value) {
                            ?>
                                <tr data-id="<?php echo $value['id'];?>"><td><?php echo $value['name'];?></td>
                                    <td data-id="<?php echo $value['id'];?>" class="delete" style="text-align: right;">X</td><td style="display:none;"><input type="hidden" name="locations[_ids][]" value="<?php echo $value['id'];?>"></td>
                                </tr>
                ...
                <div class="card">
                  <div class="table-responsive">
                    <table class="table table-vcenter card-table table-striped" id='job-allowed-data'>
                      ...
                      <tbody> 
                      <?php
                            foreach ($employee->job_types as $key => $value) {
                            ?>
                                <tr data-id="<?php echo $value['id'];?>"><td><?php echo $value['name'];?></td>
                                    <td data-id="<?php echo $value['id'];?>" class="delete" style="text-align: right;">X</td><td style="display:none;"><input type="hidden" name="job_types[_ids][]" value="<?php echo $value['id'];?>"></td>
                                </tr>
                ...
                <div class="card">
                  <div class="table-responsive">
                    <table class="table table-vcenter card-table table-striped" id='travel-with-data'>
                      ...
                      <tbody>  
                        <?php
                            foreach ($employee->employees_travelwith as $key => $value) {
                            ?>
                                <tr data-id="<?php echo $value['employees_travelwith'];?>"><td><?php echo $value['employee']['name'];?></td>
                                    <td data-id="<?php echo $value['employees_travelwith'];?>" class="delete" style="text-align: right;">X</td><td style="display:none;"><input type="hidden" name="employees_travelwith[]" value="<?php echo $value['id'];?>"></td>
                                </tr>
      ...
      $("#clients").autocomplete({
           source: function(request, response) {
                    ...
                    var exitingId = $("input[name='clients[_ids][]']").map(function(){return $(this).val();}).get();
                      ...
                      $.getJSON("<?php echo $this->Url->build(["controller" => "employees", "action" => "ajax-clients"]) ?>", { str: $('#clients').val(),  exitingId : exitingId}, response);
                  },
           minLength: 2,
      ...
      $("#locations").autocomplete({
           source: function(request, response) {
                    ...
                    var exitingId = $("input[name='locations[_ids][]']").map(function(){return $(this).val();}).get();
                      ...
                      $.getJSON("<?php echo $this->Url->build(["controller" => "employees", "action" => "ajax-locations"]) ?>", { str: $('#locations').val(),  exitingId : exitingId}, response);
                  },
           minLength: 2,
           select: function (event, ui) {
            console.log(ui.item.value);
      ...
      $("#job-allowed").autocomplete({
           source: function(request, response) {
                    ...
                    var exitingId = $("input[name='job_types[_ids][]']").map(function(){return $(this).val();}).get();
                      ...
                      $.getJSON("<?php echo $this->Url->build(["controller" => "employees", "action" => "ajax-job-allowed"]) ?>", { str: $('#job-allowed').val(),  exitingId : exitingId}, response);
                  },
           minLength: 2,
           select: function (event, ui) {
            console.log(ui.item.value);
