...
class LeadsController extends AppController {
	...
	public function index() {
		$pageTitle = 'Leads';
		$query = $this->Leads->find()->contain(['Clients', 'LeadTypes', 'LeadSources', 'LeadStatus', 'Locations', 'States', 'Countries']);
		...
		$query->where(['Leads.lead_status_id' => 1, 'Leads.location_id' => 1]);
	...
	public function allLead() {
		...
		$paginateArray['conditions'][] = ['Leads.location_id' => 1];
