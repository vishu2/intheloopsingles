<div class="page-header">
	<div class="row align-items-center">
		...
		<div class="col-auto ml-auto d-print-none">        
			...
			<a class="btn btn-primary ml-3 d-sm-none btn-icon" href="<?= $this->Url->build(['controller'=>'travels', 'action'=> 'add'])?>">
	...
	<div class="row">
		<div class="col-12 card">
			<div class="card-header">
				<h4 class="card-title">Add New Travel Event</h4>           
			</div>
			<?= $this->Form->Create($travel, ['id'=>'addtravel','class'=>'convert-lead','type'=>'file']) ?>
			<div class="card-body">
				<div class="row">
					<!-- <div class="col-12"> -->
						...
						<div class="tab-content">
									...
									<div class="col-md-4 col-lg-4 col-xl-4">
									   <div class="mb-3">
							              ...
							              <div class="input-group date" id="d_date">
							                <input class="form-control ignore" name="depart_date" required="true"/><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-calendar my-1"></i></span></span>
							              </div>
									...
									<div class="col-md-4 col-lg-4 col-xl-4">
									   <div class="mb-3">
										  ...
										  <div class="input-group date" id="r_date">
							                <input class="form-control ignore" name="return_date" /><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-calendar my-1"></i></span></span>
							              </div>
							...
							<div class="tab-pane" id="tab-ticket-info">
								<div class="row mt-4">
									<div class="col-md-4 col-lg-4 col-xl-4">
									   <div class="mb-3">
										  <label class="form-label">Single Cost</label>
									...
									<div class="col-md-4 col-lg-4 col-xl-4">
									   <div class="mb-3">
										  ...
										  <?= $this->Form->control('deposit', ['label' => false, 'class'=> 'form-control ignore', 'required' => false]) ?>
									   </div>
									</div>
									<div class="col-md-4 col-lg-4 col-xl-4">
									   <div class="mb-3">
									...
									<div class="col-md-4 col-lg-4 col-xl-4">
									   <div class="mb-3">
										  ...
										  <div class="input-group date" id="pay_date">
							                <input class="form-control ignore" name="pay_due" /><span class="input-group-append input-group-addon"><span class="input-group-text"><i class="fa fa-calendar my-1"></i></span></span>
							              </div>
							...
							<div class="tab-pane" id="tab-notes">
								...
								<div class="row d-flex">
			                       <div class="d-flex">
			                         <button type="submit" class="btn btn-primary save-travel-event">Save</button>
                         			<button type="button" class="btn btn-link prev-step">Previous</button>
			                      </div>
			                   </div>
							</div>
