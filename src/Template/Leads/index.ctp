   ...
   <div class="card card-body">
      ...
      <div class="row">
         <div class="form-group col-md-2">
            ...
            <?= $this->Form->control('name', ['label' => false, 'class' => 'form-control', 'placeholder' => 'Enter name', 'value' => @$squery['name']]) ?>
         </div>
         ...
         <table class="table table-vcenter card-table">
            <thead>
               <tr>
                  ...
                  <th scope="col">
                     <?= $this->Paginator->sort('lead_location_id', 'Lead Location') ?>
                  </th>
                  <!-- <th scope="col">
            ...
            <tbody>
               ...
               <tr data-id="<?= $lead->id; ?>">
                  ...
                  <td class="text-muted">
                     ...
                     <span class="badge bg-green-lt"><?= $lead->lead_status->status_name ?></span>
                    ...
                    <div class="row mt-4">
                     <div class="col-md-4 col-lg-4 col-xl-4">
                        <div class="mb-3">
                           ...
                           <?= $this->Form->control('no_of_months', ['label' => false, 'class'=> 'form-control ignore', 'placeholder' => 'No. of months', 'id'=> 'no_of_months', 'required' => true]) ?>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4 col-xl-4">
                        <div class="mb-3">
                           <label class="form-label">Down Payment</label>
                           <?= $this->Form->control('down_payment', ['label' => false, 'class'=> 'form-control ignore', 'placeholder' => 'Down payment amount', 'required' => true]) ?>
                        </div>
                     </div>
                     <div class="col-md-4 col-lg-4 col-xl-4">
                        <div class="mb-3">
                           <label class="form-label">Payment Date</label>
                           <?= $this->Form->control('payment_date', ['label' => false, 'class'=> 'form-control payment_date ignore', 'required' => true]) ?>
                        </div>
                     </div>
                      <div class="col-md-4 col-lg-4 col-xl-4">
                        <div class="mb-3">
                     ...
                     <div class="col-md-4 col-lg-4 col-xl-4">
                        <div class="mb-3">
                           ...
                           <?= $this->Form->select('pay_in_full',[1=>'Yes', 2=>'No'], ['label' => false, 'class'=> 'form-control ignore', 'placeholder' => 'Enter Name', 'required' => true]) ?>
                        </div>
                     </div>
                   </div>
                   <div class="row">
                     ...
                     <div class="row mt-4">
                        <div class="col-md-4 col-lg-4 col-xl-4">
                           <div class="mb-3">
                              ...
                              <?= $this->Form->control('user_profiles.0.first_name', ['label' => false, 'class'=> 'form-control ignore', 'placeholder' => 'First Name', 'required' => true]) ?>
                           </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-xl-4">
                           <div class="mb-3">
                              <label class="form-label">Last Name</label>
                              <?= $this->Form->control('user_profiles.0.last_name', ['label' => false, 'class'=> 'form-control ignore', 'placeholder' => 'Last Name', 'required' => true]) ?>
                           </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-xl-4">
                           <div class="mb-3">
                              <label class="form-label">Cell Phone</label>
                              <?= $this->Form->control('user_profiles.0.mobile', ['label' => false, 'class'=> 'form-control ignore', 'placeholder' => 'Enter Name', 'required' => true]) ?>
                           </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-xl-4">
                           <div class="mb-3">
                        ...
                        <div class="col-md-4 col-lg-4 col-xl-4">
                           <div class="mb-3">
                              ...
                              <?= $this->Form->control('user_profiles.0.age', ['label' => false, 'class'=> 'form-control ignore', 'placeholder' => 'Enter Age', 'required' => true]) ?>
                           </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-xl-4">
                           <div class="form-group mb-3">
                              ...
                              <label class="form-check form-check-inline">
                                 <input class="form-check-input" name="user_profiles[0][sex]" value="1" type="radio" checked>
                                 <span class="form-check-label">Male</span>
                               </label>
                               <label class="form-check form-check-inline">
                                 <input class="form-check-input" name="user_profiles[0][sex]" value="2" type="radio">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                           <div class="mb-3">
                              ...
                              <?= $this->Form->textarea('user_profiles.0.address', ['label' => false, 'class'=> 'form-control ignore', 'placeholder' => 'Enter Address','rows' => '5', 'cols' => '5']) ?>
                           </div>
                        </div>
                     </div>
                     <div class="row">
...
<script>
    ...
    $(document).on('click', '.convert-to-member', function(){
      var $this = $(this);
      $("#user-profiles-0-first-name").val($this.attr('data-name').split(' ')[0]);
      $("#user-profiles-0-last-name").val($this.attr('data-name').split(' ')[1]);
      $("#user-profiles-0-mobile").val($this.attr('data-mobile'));
