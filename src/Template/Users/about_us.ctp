...
<section class="become_sec">
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-sm-3">
				<a href="#" class="appointment_btn btn">Set your Appointment!</a>
			</div>
		</div>
		<div class="row">
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-7 dating">
				...
				<p>Meet new singles friends without any pressure! In the loop plans about 30 activities a month and 5-6 trips a year just for singles! Make new single friends the natural way, face to face while having fun!</p>
...
<section class="membership_sec">
	<div class="container">
		<div class="text-center">
			...
			<p>In the Loop Singles is a membership based activity and travel club. Our memberships breakdown to as low as $20 per week. About half of our activities are completely free to attend or under $10.
			We will go over all membership options, help you find the package that suits your lifestyle best, and answer all of your questions at your appointment.
			</p>
			<h3 class="sec_head_second">Our Team</h3>
		</div>
		<div class="row">
			<div class="col-sm-3">
